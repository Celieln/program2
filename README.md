...
4. Jalankan server Apache. Buka http://localhost/program2.
...
Kontribusi sangat diterima! Baca [CONTRIBUTING](CONTRIBUTING.md) dan buka [Issues](https://github.com/Celieln/program2/issues) untuk melaporkan bug / request fitur.
